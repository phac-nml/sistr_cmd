...
from sistr_cmd.qc.constants import ERR_MISSING_CGMLST_MARKERS, WARN_MISSING_CGMLST_MARKERS, SALMONELLA_GENOME_SIZE_MBP
from sistr_cmd.serovar_prediction import CGMLST_DISTANCE_THRESHOLD


def quality_check(fasta_path, cgmlst_results, prediction):
    qc_status = 'PASS'
    qc_msgs = []
